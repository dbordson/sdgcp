...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.supersededdt'
        db.add_column(u'sdapp_form345entry', 'supersededdt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.supersededdt'
        db.delete_column(u'sdapp_form345entry', 'supersededdt')
