...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.affiliation'
        db.add_column(u'sdapp_form345entry', 'affiliation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.Affiliation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.affiliation'
        db.delete_column(u'sdapp_form345entry', 'affiliation_id')
