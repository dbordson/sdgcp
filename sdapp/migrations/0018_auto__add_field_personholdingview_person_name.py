...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonHoldingView.person_name'
        db.add_column(u'sdapp_personholdingview', 'person_name',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonHoldingView.person_name'
        db.delete_column(u'sdapp_personholdingview', 'person_name')
