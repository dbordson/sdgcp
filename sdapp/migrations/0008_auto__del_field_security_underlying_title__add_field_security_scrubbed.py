...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Security.underlying_title'
        db.delete_column(u'sdapp_security', 'underlying_title')

        # Adding field 'Security.scrubbed_underlying_title'
        db.add_column(u'sdapp_security', 'scrubbed_underlying_title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Security.underlying_title'
        db.add_column(u'sdapp_security', 'underlying_title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Deleting field 'Security.scrubbed_underlying_title'
        db.delete_column(u'sdapp_security', 'scrubbed_underlying_title')
