...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SigDisplay.cs_net_shares'
        db.add_column(u'sdapp_sigdisplay', 'cs_net_shares',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SigDisplay.cs_net_shares'
        db.delete_column(u'sdapp_sigdisplay', 'cs_net_shares')
