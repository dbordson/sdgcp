...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YearlyReportingPersonAtts.transactions'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'transactions')

        # Deleting field 'YearlyReportingPersonAtts.t_perf'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 't_perf')

        # Deleting field 'YearlyReportingPersonAtts.b_perf'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'b_perf')

        # Deleting field 'YearlyReportingPersonAtts.t_win_rate'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 't_win_rate')

        # Deleting field 'YearlyReportingPersonAtts.s_perf'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 's_perf')

        # Deleting field 'YearlyReportingPersonAtts.activity_threshold'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'activity_threshold')

        # Deleting field 'YearlyReportingPersonAtts.sells'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'sells')

        # Deleting field 'YearlyReportingPersonAtts.s_win_rate'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 's_win_rate')

        # Adding field 'YearlyReportingPersonAtts.b_perf_180'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'b_perf_180',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'YearlyReportingPersonAtts.transactions'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'transactions',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.t_perf'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 't_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.b_perf'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'b_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.t_win_rate'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 't_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.s_perf'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 's_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.activity_threshold'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'activity_threshold',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.sells'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'sells',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'YearlyReportingPersonAtts.s_win_rate'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 's_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Deleting field 'YearlyReportingPersonAtts.b_perf_180'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'b_perf_180')
