...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportingPersonAtts.b_perf_10'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_10',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf_30'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_30',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf_60'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_60',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf_90'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_90',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf_120'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_120',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf_150'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf_150',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportingPersonAtts.b_perf_10'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_10')

        # Deleting field 'ReportingPersonAtts.b_perf_30'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_30')

        # Deleting field 'ReportingPersonAtts.b_perf_60'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_60')

        # Deleting field 'ReportingPersonAtts.b_perf_90'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_90')

        # Deleting field 'ReportingPersonAtts.b_perf_120'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_120')

        # Deleting field 'ReportingPersonAtts.b_perf_150'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf_150')
