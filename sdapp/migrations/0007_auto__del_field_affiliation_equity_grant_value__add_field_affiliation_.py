...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.equity_grant_value'
        db.delete_column(u'sdapp_affiliation', 'equity_grant_value')
    ...
    def backwards(self, orm):
        # Adding field 'Affiliation.equity_grant_value'
        db.add_column(u'sdapp_affiliation', 'equity_grant_value',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
