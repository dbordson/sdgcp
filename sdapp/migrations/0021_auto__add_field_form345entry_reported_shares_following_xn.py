...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.reported_shares_following_xn'
        db.add_column(u'sdapp_form345entry', 'reported_shares_following_xn',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.reported_shares_following_xn'
        db.delete_column(u'sdapp_form345entry', 'reported_shares_following_xn')
