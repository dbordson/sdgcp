...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.expected_recent_10b5_1_sale_amount'
        db.delete_column(u'sdapp_affiliation', 'expected_recent_10b5_1_sale_amount')

        # Deleting field 'Affiliation.num_in_avg_prior_10b5_1_trigger_perf'
        db.delete_column(u'sdapp_affiliation', 'num_in_avg_prior_10b5_1_trigger_perf')

        # Deleting field 'Affiliation.avg_prior_10b5_1_trigger_perf'
        db.delete_column(u'sdapp_affiliation', 'avg_prior_10b5_1_trigger_perf')

        # Deleting field 'Affiliation.increase_in_10b5_1_selling'
        db.delete_column(u'sdapp_affiliation', 'increase_in_10b5_1_selling')

        # Deleting field 'Affiliation.price_trigger_detected'
        db.delete_column(u'sdapp_affiliation', 'price_trigger_detected')

        # Deleting field 'Affiliation.selling_price'
        db.delete_column(u'sdapp_affiliation', 'selling_price')

        # Deleting field 'Affiliation.selling_date'
        db.delete_column(u'sdapp_affiliation', 'selling_date')

        # Deleting field 'Affiliation.avg_prior_trigger_perf'
        db.delete_column(u'sdapp_affiliation', 'avg_prior_trigger_perf')

        # Deleting field 'Affiliation.selling_subs_performance'
        db.delete_column(u'sdapp_affiliation', 'selling_subs_performance')

        # Deleting field 'Affiliation.selling_prior_performance'
        db.delete_column(u'sdapp_affiliation', 'selling_prior_performance')

        # Deleting field 'Affiliation.num_in_avg_prior_trigger_perf'
        db.delete_column(u'sdapp_affiliation', 'num_in_avg_prior_trigger_perf')
        ...
        # Adding field 'Affiliation.expected_recent_sale_amount_10b5_1'
        db.add_column(u'sdapp_affiliation', 'expected_recent_sale_amount_10b5_1',
        ...
        # Adding field 'Affiliation.selling_price_10b5_1'
        db.add_column(u'sdapp_affiliation', 'selling_price_10b5_1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.avg_prior_trigger_perf_10b5_1'
        db.add_column(u'sdapp_affiliation', 'avg_prior_trigger_perf_10b5_1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.num_in_avg_prior_trigger_perf_10b5_1'
        db.add_column(u'sdapp_affiliation', 'num_in_avg_prior_trigger_perf_10b5_1',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Affiliation.expected_recent_10b5_1_sale_amount'
        db.add_column(u'sdapp_affiliation', 'expected_recent_10b5_1_sale_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.num_in_avg_prior_10b5_1_trigger_perf'
        db.add_column(u'sdapp_affiliation', 'num_in_avg_prior_10b5_1_trigger_perf',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.avg_prior_10b5_1_trigger_perf'
        db.add_column(u'sdapp_affiliation', 'avg_prior_10b5_1_trigger_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.increase_in_10b5_1_selling'
        db.add_column(u'sdapp_affiliation', 'increase_in_10b5_1_selling',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Affiliation.price_trigger_detected'
        db.add_column(u'sdapp_affiliation', 'price_trigger_detected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Affiliation.selling_price'
        db.add_column(u'sdapp_affiliation', 'selling_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.selling_date'
        db.add_column(u'sdapp_affiliation', 'selling_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.avg_prior_trigger_perf'
        db.add_column(u'sdapp_affiliation', 'avg_prior_trigger_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.selling_subs_performance'
        db.add_column(u'sdapp_affiliation', 'selling_subs_performance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.selling_prior_performance'
        db.add_column(u'sdapp_affiliation', 'selling_prior_performance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.num_in_avg_prior_trigger_perf'
        db.add_column(u'sdapp_affiliation', 'num_in_avg_prior_trigger_perf',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
        ...
        # Deleting field 'Affiliation.expected_recent_sale_amount_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'expected_recent_sale_amount_10b5_1')

        # Deleting field 'Affiliation.selling_date_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'selling_date_10b5_1')

        # Deleting field 'Affiliation.selling_price_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'selling_price_10b5_1')
        ...
        # Deleting field 'Affiliation.avg_prior_trigger_perf_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'avg_prior_trigger_perf_10b5_1')

        # Deleting field 'Affiliation.num_in_avg_prior_trigger_perf_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'num_in_avg_prior_trigger_perf_10b5_1')
    ...
    models = {
        ...
        u'sdapp.affiliation': {
            ...
            'annualized_perf_from_beg_2012_to_today': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            'avg_prior_trigger_perf_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            'expected_recent_sale_amount_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            'num_in_avg_prior_trigger_perf_10b5_1': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'person_name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
            'post_sale_perf_10b_12mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_10b_3mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_10b_6mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_10b_9mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_12mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_3mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_6mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'post_sale_perf_9mo': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            'quarters_with_10b_sales_since_beg_2012': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'quarters_with_sales_since_beg_2012': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'selling_price_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'selling_prior_performance_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'selling_subs_performance_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
