...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SigDisplay.sow_plural_insiders'
        db.delete_column(u'sdapp_sigdisplay', 'sow_plural_insiders')

        # Deleting field 'SigDisplay.sow_person_name'
        db.delete_column(u'sdapp_sigdisplay', 'sow_person_name')

        # Deleting field 'SigDisplay.sow_includes_ceo'
        db.delete_column(u'sdapp_sigdisplay', 'sow_includes_ceo')

        # Deleting field 'SigDisplay.sell_on_weakness'
        db.delete_column(u'sdapp_sigdisplay', 'sell_on_weakness')

        # Deleting field 'SigDisplay.sow_first_post_stock_perf'
        db.delete_column(u'sdapp_sigdisplay', 'sow_first_post_stock_perf')

        # Deleting field 'SigDisplay.sow_first_perf_period_days'
        db.delete_column(u'sdapp_sigdisplay', 'sow_first_perf_period_days')

        # Deleting field 'SigDisplay.sow_first_sig_detect_date'
        db.delete_column(u'sdapp_sigdisplay', 'sow_first_sig_detect_date')

        # Deleting field 'SigDisplay.sow_net_signal_value'
        db.delete_column(u'sdapp_sigdisplay', 'sow_net_signal_value')

        # Deleting field 'SigDisplay.sow_first_pre_stock_perf'
        db.delete_column(u'sdapp_sigdisplay', 'sow_first_pre_stock_perf')
        ...
        # Adding field 'SigDisplay.sos_plural_insiders'
        db.add_column(u'sdapp_sigdisplay', 'sos_plural_insiders',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_first_sig_detect_date'
        db.add_column(u'sdapp_sigdisplay', 'sos_first_sig_detect_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_person_name'
        db.add_column(u'sdapp_sigdisplay', 'sos_person_name',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_includes_ceo'
        db.add_column(u'sdapp_sigdisplay', 'sos_includes_ceo',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_net_signal_value'
        db.add_column(u'sdapp_sigdisplay', 'sos_net_signal_value',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_first_perf_period_days'
        db.add_column(u'sdapp_sigdisplay', 'sos_first_perf_period_days',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_first_pre_stock_perf'
        db.add_column(u'sdapp_sigdisplay', 'sos_first_pre_stock_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_first_post_stock_perf'
        db.add_column(u'sdapp_sigdisplay', 'sos_first_post_stock_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SigDisplay.sow_plural_insiders'
        db.add_column(u'sdapp_sigdisplay', 'sow_plural_insiders',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_person_name'
        db.add_column(u'sdapp_sigdisplay', 'sow_person_name',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_includes_ceo'
        db.add_column(u'sdapp_sigdisplay', 'sow_includes_ceo',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sell_on_weakness'
        db.add_column(u'sdapp_sigdisplay', 'sell_on_weakness',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_first_post_stock_perf'
        db.add_column(u'sdapp_sigdisplay', 'sow_first_post_stock_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_first_perf_period_days'
        db.add_column(u'sdapp_sigdisplay', 'sow_first_perf_period_days',
                      self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_first_sig_detect_date'
        db.add_column(u'sdapp_sigdisplay', 'sow_first_sig_detect_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_net_signal_value'
        db.add_column(u'sdapp_sigdisplay', 'sow_net_signal_value',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'SigDisplay.sow_first_pre_stock_perf'
        db.add_column(u'sdapp_sigdisplay', 'sow_first_pre_stock_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Deleting field 'SigDisplay.sos_plural_insiders'
        db.delete_column(u'sdapp_sigdisplay', 'sos_plural_insiders')

        # Deleting field 'SigDisplay.sos_first_sig_detect_date'
        db.delete_column(u'sdapp_sigdisplay', 'sos_first_sig_detect_date')

        # Deleting field 'SigDisplay.sos_person_name'
        db.delete_column(u'sdapp_sigdisplay', 'sos_person_name')

        # Deleting field 'SigDisplay.sos_includes_ceo'
        db.delete_column(u'sdapp_sigdisplay', 'sos_includes_ceo')

        # Deleting field 'SigDisplay.sos_net_signal_value'
        db.delete_column(u'sdapp_sigdisplay', 'sos_net_signal_value')

        # Deleting field 'SigDisplay.sos_first_perf_period_days'
        db.delete_column(u'sdapp_sigdisplay', 'sos_first_perf_period_days')

        # Deleting field 'SigDisplay.sos_first_pre_stock_perf'
        db.delete_column(u'sdapp_sigdisplay', 'sos_first_pre_stock_perf')

        # Deleting field 'SigDisplay.sos_first_post_stock_perf'
        db.delete_column(u'sdapp_sigdisplay', 'sos_first_post_stock_perf')
