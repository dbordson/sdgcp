...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'sdapp_signal', (
            ...
            ('reporting_person_name', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80)),
            ('signal_id_code', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('security_title', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80)),
            ('signal_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4)),
            ('signal_name', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80)),
            ('short_statement', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=200)),
            ('security_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4)),
            ('unit_conversion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4)),
            ('reporting_person_title', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80)),
            ('sph', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.SecurityPriceHist'], null=True)),
            ('reporting_person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.ReportingPerson'])),
            ('long_statement', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=200)),
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('formentrysource', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80)),
            ('issuer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.IssuerCIK'])),
        ))
