...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form345Entry.underlying_shares'
        db.alter_column(u'sdapp_form345entry', 'underlying_shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Form345Entry.transaction_shares'
        db.alter_column(u'sdapp_form345entry', 'transaction_shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Form345Entry.xn_price_per_share'
        db.alter_column(u'sdapp_form345entry', 'xn_price_per_share', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Form345Entry.conversion_price'
        db.alter_column(u'sdapp_form345entry', 'conversion_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Form345Entry.shares_following_xn'
        db.alter_column(u'sdapp_form345entry', 'shares_following_xn', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Form345Entry.underlying_shares'
        db.alter_column(u'sdapp_form345entry', 'underlying_shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

        # Changing field 'Form345Entry.transaction_shares'
        db.alter_column(u'sdapp_form345entry', 'transaction_shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

        # Changing field 'Form345Entry.xn_price_per_share'
        db.alter_column(u'sdapp_form345entry', 'xn_price_per_share', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

        # Changing field 'Form345Entry.conversion_price'
        db.alter_column(u'sdapp_form345entry', 'conversion_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

        # Changing field 'Form345Entry.shares_following_xn'
        db.alter_column(u'sdapp_form345entry', 'shares_following_xn', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))
    ...
    models = {
        ...
        u'sdapp.form345entry': {
            ...
            'reporting_owner_name': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
            'reporting_owner_title': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
            'security_title': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
            ...
            'underlying_title': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
