...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.xn_days'
        db.delete_column(u'sdapp_affiliation', 'xn_days')

        # Deleting field 'Affiliation.price_trigger_detected'
        db.delete_column(u'sdapp_affiliation', 'price_trigger_detected')

        # Deleting field 'Affiliation.increase_in_selling'
        db.delete_column(u'sdapp_affiliation', 'increase_in_selling')

        # Deleting field 'Affiliation.selling_close_price'
        db.delete_column(u'sdapp_affiliation', 'selling_close_price')
        ...
        # Deleting field 'Affiliation.expected_recent_share_sale_amount'
        db.delete_column(u'sdapp_affiliation', 'expected_recent_share_sale_amount')

        # Deleting field 'Affiliation.recent_share_sale_amount'
        db.delete_column(u'sdapp_affiliation', 'recent_share_sale_amount')

        # Deleting field 'Affiliation.selling_prior_performance'
        db.delete_column(u'sdapp_affiliation', 'selling_prior_performance')

        # Adding field 'Affiliation.shares_recently_sold_disc'
        db.add_column(u'sdapp_affiliation', 'shares_recently_sold_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.value_recently_sold_disc'
        db.add_column(u'sdapp_affiliation', 'value_recently_sold_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.shares_historically_sold_disc'
        db.add_column(u'sdapp_affiliation', 'shares_historically_sold_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.value_historically_sold_disc'
        db.add_column(u'sdapp_affiliation', 'value_historically_sold_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.recent_share_sale_amount_disc'
        db.add_column(u'sdapp_affiliation', 'recent_share_sale_amount_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Affiliation.xn_days'
        db.add_column(u'sdapp_affiliation', 'xn_days',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.increase_in_selling'
        db.add_column(u'sdapp_affiliation', 'increase_in_selling',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Affiliation.selling_close_price'
        db.add_column(u'sdapp_affiliation', 'selling_close_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.expected_recent_share_sale_amount'
        db.add_column(u'sdapp_affiliation', 'expected_recent_share_sale_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.recent_share_sale_amount'
        db.add_column(u'sdapp_affiliation', 'recent_share_sale_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Deleting field 'Affiliation.shares_recently_sold_disc'
        db.delete_column(u'sdapp_affiliation', 'shares_recently_sold_disc')

        # Deleting field 'Affiliation.value_recently_sold_disc'
        db.delete_column(u'sdapp_affiliation', 'value_recently_sold_disc')

        # Deleting field 'Affiliation.shares_historically_sold_disc'
        db.delete_column(u'sdapp_affiliation', 'shares_historically_sold_disc')

        # Deleting field 'Affiliation.value_historically_sold_disc'
        db.delete_column(u'sdapp_affiliation', 'value_historically_sold_disc')
        ...
        # Deleting field 'Affiliation.recent_share_sale_amount_disc'
        db.delete_column(u'sdapp_affiliation', 'recent_share_sale_amount_disc')
    ...
    models = {
        ...
        u'sdapp.affiliation': {
            ...
            'recent_share_sale_amount_disc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            'shares_historically_sold_disc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'shares_recently_sold_disc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'value_historically_sold_disc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'value_recently_sold_disc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
