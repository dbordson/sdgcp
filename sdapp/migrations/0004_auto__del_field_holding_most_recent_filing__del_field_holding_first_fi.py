...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Holding.most_recent_filing'
        db.delete_column(u'sdapp_holding', 'most_recent_filing')

        # Deleting field 'Holding.first_filing'
        db.delete_column(u'sdapp_holding', 'first_filing')

        # Adding field 'Holding.first_xn'
        db.add_column(u'sdapp_holding', 'first_xn',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Holding.most_recent_xn'
        db.add_column(u'sdapp_holding', 'most_recent_xn',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Holding.most_recent_filing'
        db.add_column(u'sdapp_holding', 'most_recent_filing',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Holding.first_filing'
        db.add_column(u'sdapp_holding', 'first_filing',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Holding.first_xn'
        db.delete_column(u'sdapp_holding', 'first_xn')

        # Deleting field 'Holding.most_recent_xn'
        db.delete_column(u'sdapp_holding', 'most_recent_xn')
