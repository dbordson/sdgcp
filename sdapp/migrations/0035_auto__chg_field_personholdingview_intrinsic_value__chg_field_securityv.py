...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonHoldingView.intrinsic_value'
        db.alter_column(u'sdapp_personholdingview', 'intrinsic_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4))

        # Changing field 'SecurityView.intrinsic_value'
        db.alter_column(u'sdapp_securityview', 'intrinsic_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'PersonHoldingView.intrinsic_value'
        db.alter_column(u'sdapp_personholdingview', 'intrinsic_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'SecurityView.intrinsic_value'
        db.alter_column(u'sdapp_securityview', 'intrinsic_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))
