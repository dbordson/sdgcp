...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WatchedName.last_signal_sent'
        db.alter_column(u'sdapp_watchedname', 'last_signal_sent', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'WatchedName.last_signal_sent'
        db.alter_column(u'sdapp_watchedname', 'last_signal_sent', self.gf('django.db.models.fields.DateTimeField')(null=True))
