...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sdapp_recommendation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issuer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.IssuerCIK'])),
            ('sentiment', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=20)),
            ('confidence', self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=20)),
        ))
        db.send_create_signal(u'sdapp', ['Recommendation'])


    def backwards(self, orm):
        # Deleting model 'Recommendation'
        db.delete_table(u'sdapp_recommendation')
