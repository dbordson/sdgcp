...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Security.security_title'
        db.delete_column(u'sdapp_security', 'security_title')

        # Adding field 'Security.short_sec_title'
        db.add_column(u'sdapp_security', 'short_sec_title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Security.security_title'
        db.add_column(u'sdapp_security', 'security_title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)

        # Deleting field 'Security.short_sec_title'
        db.delete_column(u'sdapp_security', 'short_sec_title')
