...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Signal.signal_value'
        db.alter_column(u'sdapp_signal', 'signal_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Signal.security_units'
        db.alter_column(u'sdapp_signal', 'security_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Signal.unit_conversion'
        db.alter_column(u'sdapp_signal', 'unit_conversion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Signal.transactions'
        db.alter_column(u'sdapp_signal', 'transactions', self.gf('django.db.models.fields.IntegerField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Signal.signal_value'
        db.alter_column(u'sdapp_signal', 'signal_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'Signal.security_units'
        db.alter_column(u'sdapp_signal', 'security_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'Signal.unit_conversion'
        db.alter_column(u'sdapp_signal', 'unit_conversion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'Signal.transactions'
        db.alter_column(u'sdapp_signal', 'transactions', self.gf('django.db.models.fields.IntegerField')(max_length=10))
