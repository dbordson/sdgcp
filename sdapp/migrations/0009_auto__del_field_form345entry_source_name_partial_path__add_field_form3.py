...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Form345Entry.source_name_partial_path'
        db.delete_column(u'sdapp_form345entry', 'source_name_partial_path')

        # Adding field 'Form345Entry.sec_path'
        db.add_column(u'sdapp_form345entry', 'sec_path',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Form345Entry.source_name_partial_path'
        db.add_column(u'sdapp_form345entry', 'source_name_partial_path',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)

        # Deleting field 'Form345Entry.sec_path'
        db.delete_column(u'sdapp_form345entry', 'sec_path')
