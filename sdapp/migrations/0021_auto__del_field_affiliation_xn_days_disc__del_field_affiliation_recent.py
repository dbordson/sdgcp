...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Affiliation.recent_share_sale_amount_10b5_1'
        db.delete_column(u'sdapp_affiliation', 'recent_share_sale_amount_10b5_1')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Affiliation.recent_share_sale_amount_10b5_1'
        db.add_column(u'sdapp_affiliation', 'recent_share_sale_amount_10b5_1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
