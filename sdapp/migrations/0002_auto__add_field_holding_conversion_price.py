...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Holding.conversion_price'
        db.add_column(u'sdapp_holding', 'conversion_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Holding.conversion_price'
        db.delete_column(u'sdapp_holding', 'conversion_price')
