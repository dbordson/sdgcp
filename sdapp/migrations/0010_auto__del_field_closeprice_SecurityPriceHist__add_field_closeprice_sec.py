...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SecurityView.underlying_price'
        db.delete_column(u'sdapp_securityview', 'underlying_price')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SecurityView.underlying_price'
        db.add_column(u'sdapp_securityview', 'underlying_price',
