...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signal.reporting_person_name'
        db.add_column(u'sdapp_signal', 'reporting_person_name',
                      self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80),
                      keep_default=False)

        # Adding field 'Signal.reporting_person_title'
        db.add_column(u'sdapp_signal', 'reporting_person_title',
                      self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80),
                      keep_default=False)

        # Adding field 'Signal.security_title'
        db.add_column(u'sdapp_signal', 'security_title',
                      self.gf('django.db.models.fields.CharField')(default='ERROR', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signal.reporting_person_name'
        db.delete_column(u'sdapp_signal', 'reporting_person_name')

        # Deleting field 'Signal.reporting_person_title'
        db.delete_column(u'sdapp_signal', 'reporting_person_title')

        # Deleting field 'Signal.security_title'
        db.delete_column(u'sdapp_signal', 'security_title')
    ...
    models = {
        ...
        u'sdapp.signal': {
            ...
            'statement': ('django.db.models.fields.CharField', [], {'default': "'ERROR'", 'max_length': '200'}),
