...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Form345Entry.source_name_partial_path'
        db.alter_column(u'sdapp_form345entry', 'source_name_partial_path', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Form345Entry.source_name_partial_path'
        db.alter_column(u'sdapp_form345entry', 'source_name_partial_path', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
    ...
    models = {
        ...
        u'sdapp.aggholdingtype': {
            'Meta': {'object_name': 'AggHoldingType'},
        ...
        u'sdapp.form345entry': {
            ...
            'filedatetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'source_name_partial_path': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
