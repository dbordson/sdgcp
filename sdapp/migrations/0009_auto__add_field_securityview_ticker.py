...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecurityView.ticker'
        db.add_column(u'sdapp_securityview', 'ticker',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecurityView.ticker'
        db.delete_column(u'sdapp_securityview', 'ticker')
