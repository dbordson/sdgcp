...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.shares_following_xn_is_adjusted'
        db.add_column(u'sdapp_form345entry', 'shares_following_xn_is_adjusted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.shares_following_xn_is_adjusted'
        db.delete_column(u'sdapp_form345entry', 'shares_following_xn_is_adjusted')
