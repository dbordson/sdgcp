...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YearlyReportingPersonAtts.b_win_rate'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'b_win_rate')

        # Adding field 'YearlyReportingPersonAtts.b_win_rate_180'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'b_win_rate_180',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'YearlyReportingPersonAtts.b_win_rate'
        db.add_column(u'sdapp_yearlyreportingpersonatts', 'b_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Deleting field 'YearlyReportingPersonAtts.b_win_rate_180'
        db.delete_column(u'sdapp_yearlyreportingpersonatts', 'b_win_rate_180')
