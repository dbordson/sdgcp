...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.quarters_with_sales_since_beg_2012'
        db.delete_column(u'sdapp_affiliation', 'quarters_with_sales_since_beg_2012')

        # Deleting field 'Affiliation.annualized_perf_from_beg_2012_to_today'
        db.delete_column(u'sdapp_affiliation', 'annualized_perf_from_beg_2012_to_today')

        # Deleting field 'Affiliation.quarters_with_10b_sales_since_beg_2012'
        db.delete_column(u'sdapp_affiliation', 'quarters_with_10b_sales_since_beg_2012')

        # Adding field 'Affiliation.quarters_with_sales_in_tracking_period'
        db.add_column(u'sdapp_affiliation', 'quarters_with_sales_in_tracking_period',
        ...
        # Changing field 'Affiliation.post_sale_perf_10b_12mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_12mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.selling_subs_performance_10b5_1'
        db.alter_column(u'sdapp_affiliation', 'selling_subs_performance_10b5_1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_9mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_9mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_10b_3mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_3mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_10b_6mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_6mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_10b_9mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_9mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_6mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_6mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_12mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_12mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.post_sale_perf_3mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_3mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'Affiliation.selling_prior_performance_10b5_1'
        db.alter_column(u'sdapp_affiliation', 'selling_prior_performance_10b5_1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

    def backwards(self, orm):
        # Adding field 'Affiliation.quarters_with_sales_since_beg_2012'
        db.add_column(u'sdapp_affiliation', 'quarters_with_sales_since_beg_2012',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.annualized_perf_from_beg_2012_to_today'
        db.add_column(u'sdapp_affiliation', 'annualized_perf_from_beg_2012_to_today',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.quarters_with_10b_sales_since_beg_2012'
        db.add_column(u'sdapp_affiliation', 'quarters_with_10b_sales_since_beg_2012',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Affiliation.quarters_with_sales_in_tracking_period'
        db.delete_column(u'sdapp_affiliation', 'quarters_with_sales_in_tracking_period')
        ...
        # Changing field 'Affiliation.post_sale_perf_10b_12mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_12mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.selling_subs_performance_10b5_1'
        db.alter_column(u'sdapp_affiliation', 'selling_subs_performance_10b5_1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_9mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_9mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_10b_3mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_3mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_10b_6mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_6mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_10b_9mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_10b_9mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_6mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_6mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_12mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_12mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.post_sale_perf_3mo'
        db.alter_column(u'sdapp_affiliation', 'post_sale_perf_3mo', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'Affiliation.selling_prior_performance_10b5_1'
        db.alter_column(u'sdapp_affiliation', 'selling_prior_performance_10b5_1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))
    ...
    models = {
        ...
        u'sdapp.affiliation': {
            ...
            'quarters_with_sales_in_tracking_period': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'recent_share_sale_amount_10b5_1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
