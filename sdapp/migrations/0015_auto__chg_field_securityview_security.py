...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SecurityView.security'
        db.alter_column(u'sdapp_securityview', 'security_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sdapp.Security']))

    def backwards(self, orm):

        # Changing field 'SecurityView.security'
        db.alter_column(u'sdapp_securityview', 'security_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.Security'], null=True))
