...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.trigger_price'
        db.delete_column(u'sdapp_affiliation', 'trigger_price')

        # Deleting field 'Affiliation.trigger_date'
        db.delete_column(u'sdapp_affiliation', 'trigger_date')

        # Deleting field 'Affiliation.trigger_subs_performance'
        db.delete_column(u'sdapp_affiliation', 'trigger_subs_performance')

        # Deleting field 'Affiliation.trigger_prior_performance'
        db.delete_column(u'sdapp_affiliation', 'trigger_prior_performance')
    ...
    def backwards(self, orm):
        # Adding field 'Affiliation.trigger_price'
        db.add_column(u'sdapp_affiliation', 'trigger_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.trigger_date'
        db.add_column(u'sdapp_affiliation', 'trigger_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.trigger_subs_performance'
        db.add_column(u'sdapp_affiliation', 'trigger_subs_performance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.trigger_prior_performance'
        db.add_column(u'sdapp_affiliation', 'trigger_prior_performance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'sdapp.affiliation': {
            ...
            'avg_avg_prior_trigger_performance': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'increase_in_10b5_1_selling': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'price_trigger_detected': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'selling_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'selling_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'selling_prior_performance': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'selling_subs_performance': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
