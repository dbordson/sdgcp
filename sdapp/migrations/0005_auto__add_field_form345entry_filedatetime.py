...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.filedatetime'
        db.add_column(u'sdapp_form345entry', 'filedatetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.filedatetime'
        db.delete_column(u'sdapp_form345entry', 'filedatetime')
