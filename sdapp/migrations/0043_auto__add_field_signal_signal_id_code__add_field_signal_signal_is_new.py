...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signal.signal_id_code'
        db.add_column(u'sdapp_signal', 'signal_id_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)

        # Adding field 'Signal.signal_is_new'
        db.add_column(u'sdapp_signal', 'signal_is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signal.signal_id_code'
        db.delete_column(u'sdapp_signal', 'signal_id_code')

        # Deleting field 'Signal.signal_is_new'
        db.delete_column(u'sdapp_signal', 'signal_is_new')
    ...
    models = {
        ...
        u'sdapp.watchedname': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sdapp.IssuerCIK']"}),
            'last_signal_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
