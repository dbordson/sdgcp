...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonHoldingView.underlying_price'
        db.delete_column(u'sdapp_personholdingview', 'underlying_price')

        # Deleting field 'PersonHoldingView.underlying_shares'
        db.delete_column(u'sdapp_personholdingview', 'underlying_shares')

        # Adding field 'PersonHoldingView.security'
        db.add_column(u'sdapp_personholdingview', 'security',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sdapp.Security']),
                      keep_default=False)

        # Adding field 'PersonHoldingView.ticker'
        db.add_column(u'sdapp_personholdingview', 'ticker',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'PersonHoldingView.last_close_price'
        db.add_column(u'sdapp_personholdingview', 'last_close_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'PersonHoldingView.underlying_ticker'
        db.add_column(u'sdapp_personholdingview', 'underlying_ticker',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'PersonHoldingView.underlying_shares_total'
        db.add_column(u'sdapp_personholdingview', 'underlying_shares_total',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'PersonHoldingView.underlying_close_price'
        db.add_column(u'sdapp_personholdingview', 'underlying_close_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'SecurityView.last_close_price'
        db.add_column(u'sdapp_securityview', 'last_close_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'SecurityView.underlying_close_price'
        db.add_column(u'sdapp_securityview', 'underlying_close_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PersonHoldingView.underlying_price'
        db.add_column(u'sdapp_personholdingview', 'underlying_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'PersonHoldingView.underlying_shares'
        db.add_column(u'sdapp_personholdingview', 'underlying_shares',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Deleting field 'PersonHoldingView.security'
        db.delete_column(u'sdapp_personholdingview', 'security_id')

        # Deleting field 'PersonHoldingView.ticker'
        db.delete_column(u'sdapp_personholdingview', 'ticker')

        # Deleting field 'PersonHoldingView.last_close_price'
        db.delete_column(u'sdapp_personholdingview', 'last_close_price')

        # Deleting field 'PersonHoldingView.underlying_ticker'
        db.delete_column(u'sdapp_personholdingview', 'underlying_ticker')

        # Deleting field 'PersonHoldingView.underlying_shares_total'
        db.delete_column(u'sdapp_personholdingview', 'underlying_shares_total')

        # Deleting field 'PersonHoldingView.underlying_close_price'
        db.delete_column(u'sdapp_personholdingview', 'underlying_close_price')

        # Deleting field 'SecurityView.last_close_price'
        db.delete_column(u'sdapp_securityview', 'last_close_price')

        # Deleting field 'SecurityView.underlying_close_price'
        db.delete_column(u'sdapp_securityview', 'underlying_close_price')
