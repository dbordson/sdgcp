...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonSignal.average_price_sec_1'
        db.alter_column(u'sdapp_personsignal', 'average_price_sec_1', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'PersonSignal.prior_holding_value'
        db.alter_column(u'sdapp_personsignal', 'prior_holding_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'PersonSignal.net_signal_pct'
        db.alter_column(u'sdapp_personsignal', 'net_signal_pct', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PersonSignal.average_price_sec_1'
        db.alter_column(u'sdapp_personsignal', 'average_price_sec_1', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=15, decimal_places=2))

        # Changing field 'PersonSignal.prior_holding_value'
        db.alter_column(u'sdapp_personsignal', 'prior_holding_value', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=15, decimal_places=2))

        # Changing field 'PersonSignal.net_signal_pct'
        db.alter_column(u'sdapp_personsignal', 'net_signal_pct', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=15, decimal_places=2))
