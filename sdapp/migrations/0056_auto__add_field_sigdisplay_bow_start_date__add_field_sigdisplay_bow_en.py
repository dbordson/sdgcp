...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SigDisplay.bow_start_date'
        db.add_column(u'sdapp_sigdisplay', 'bow_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.bow_end_date'
        db.add_column(u'sdapp_sigdisplay', 'bow_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.cb_start_date'
        db.add_column(u'sdapp_sigdisplay', 'cb_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.cb_end_date'
        db.add_column(u'sdapp_sigdisplay', 'cb_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.db_start_date'
        db.add_column(u'sdapp_sigdisplay', 'db_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.db_end_date'
        db.add_column(u'sdapp_sigdisplay', 'db_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_start_date'
        db.add_column(u'sdapp_sigdisplay', 'sos_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.sos_end_date'
        db.add_column(u'sdapp_sigdisplay', 'sos_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.cs_start_date'
        db.add_column(u'sdapp_sigdisplay', 'cs_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.cs_end_date'
        db.add_column(u'sdapp_sigdisplay', 'cs_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.ds_start_date'
        db.add_column(u'sdapp_sigdisplay', 'ds_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SigDisplay.ds_end_date'
        db.add_column(u'sdapp_sigdisplay', 'ds_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SigDisplay.bow_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'bow_start_date')

        # Deleting field 'SigDisplay.bow_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'bow_end_date')

        # Deleting field 'SigDisplay.cb_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'cb_start_date')

        # Deleting field 'SigDisplay.cb_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'cb_end_date')

        # Deleting field 'SigDisplay.db_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'db_start_date')

        # Deleting field 'SigDisplay.db_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'db_end_date')

        # Deleting field 'SigDisplay.sos_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'sos_start_date')

        # Deleting field 'SigDisplay.sos_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'sos_end_date')

        # Deleting field 'SigDisplay.cs_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'cs_start_date')

        # Deleting field 'SigDisplay.cs_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'cs_end_date')

        # Deleting field 'SigDisplay.ds_start_date'
        db.delete_column(u'sdapp_sigdisplay', 'ds_start_date')

        # Deleting field 'SigDisplay.ds_end_date'
        db.delete_column(u'sdapp_sigdisplay', 'ds_end_date')
