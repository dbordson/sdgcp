...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SigDisplay.last_signal'
        db.add_column(u'sdapp_sigdisplay', 'last_signal',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SigDisplay.last_signal'
        db.delete_column(u'sdapp_sigdisplay', 'last_signal')
