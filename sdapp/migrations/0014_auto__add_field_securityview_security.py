...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SecurityView.security'
        db.add_column(u'sdapp_securityview', 'security',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.Security'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SecurityView.security'
        db.delete_column(u'sdapp_securityview', 'security_id')
