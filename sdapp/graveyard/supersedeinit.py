...
# GENERAL NOTE: SOME OF THESE QUERY SETS MAY BE INEFFECIENT
# I THINK I AM FORCING EVALUATION WHEN I WRITE .exists() AT
# THE END OF A QUERYSET.  IF SO, THIS CAUSES THE IF STATEMENTS
# TO BE EVALUATED AFTER THE QUERYSET WHICH MAY OR MAY NOT BE
# USEFUL (i.e. don't evaluate a qs if the supersededdt attribute
...
def entry_calc(entries34, untagged_entry_id, today, nonofficercutoffyears,
               nonofficercutoffdt, officercutoffyears, officercutoffdt):
        # Logic below
    ...
    if supersededdt_already_assigned is False and\
        ...
        # print 'no recent activity - officer'
        untagged_entry.save()
        supersededdt_already_assigned = True
    ...
    if supersededdt_already_assigned is False and\
        ...
        supersededdt_for_filer = \
            string_date_with_years_added(nonofficercutoffyears,
                                         latest_file_dt_as_iso)
        untagged_entry.supersededdt = supersededdt_for_filer
        # print 'no recent activity - nonofficer'
        untagged_entry.save()
...
def superseded_initialize():
    ...
    for untagged_entry_id in untagged_entry_ids:
        ...
        counter += 1.0
        entry_calc(entries34, untagged_entry_id, today, nonofficercutoffyears,
                   nonofficercutoffdt, officercutoffyears, officercutoffdt)
    print 'Done.'
    return
