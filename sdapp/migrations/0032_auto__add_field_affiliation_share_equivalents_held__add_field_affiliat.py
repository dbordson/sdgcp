...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Affiliation.selling_date_disc'
        db.add_column(u'sdapp_affiliation', 'selling_date_disc',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.selling_close_price_disc'
        db.add_column(u'sdapp_affiliation', 'selling_close_price_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.selling_prior_performance_disc'
        db.add_column(u'sdapp_affiliation', 'selling_prior_performance_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.selling_subs_performance_disc'
        db.add_column(u'sdapp_affiliation', 'selling_subs_performance_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.increase_in_buying_disc'
        db.add_column(u'sdapp_affiliation', 'increase_in_buying_disc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Affiliation.buying_date_disc'
        db.add_column(u'sdapp_affiliation', 'buying_date_disc',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buying_close_price_disc'
        db.add_column(u'sdapp_affiliation', 'buying_close_price_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.price_motivated_buy_detected_disc'
        db.add_column(u'sdapp_affiliation', 'price_motivated_buy_detected_disc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Affiliation.buying_prior_performance_disc'
        db.add_column(u'sdapp_affiliation', 'buying_prior_performance_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'Affiliation.buying_subs_performance_disc'
        db.add_column(u'sdapp_affiliation', 'buying_subs_performance_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)
        ...
        # Adding field 'Affiliation.qtrs_with_disc_sales_in_tracking_period'
        db.add_column(u'sdapp_affiliation', 'qtrs_with_disc_sales_in_tracking_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_3_mo_decline_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_decline_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_3_mo_measured_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_measured_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_6_mo_decline_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_decline_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_6_mo_measured_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_measured_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_9_mo_decline_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_decline_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_9_mo_measured_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_measured_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_12_mo_decline_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_decline_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_12_mo_measured_disc'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_measured_disc',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_3mo_disc'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_3mo_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_6mo_disc'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_6mo_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_9mo_disc'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_9mo_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_12mo_disc'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_12mo_disc',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.qtrs_with_buys_in_tracking_period'
        db.add_column(u'sdapp_affiliation', 'qtrs_with_buys_in_tracking_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_3_mo_increase'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_3_mo_increase',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_3_mo_measured'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_3_mo_measured',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_6_mo_increase'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_6_mo_increase',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_6_mo_measured'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_6_mo_measured',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_9_mo_increase'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_9_mo_increase',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_9_mo_measured'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_9_mo_measured',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_12_mo_increase'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_12_mo_increase',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.buy_qtr_ct_12_mo_measured'
        db.add_column(u'sdapp_affiliation', 'buy_qtr_ct_12_mo_measured',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.post_buy_perf_3mo'
        db.add_column(u'sdapp_affiliation', 'post_buy_perf_3mo',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_buy_perf_6mo'
        db.add_column(u'sdapp_affiliation', 'post_buy_perf_6mo',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_buy_perf_9mo'
        db.add_column(u'sdapp_affiliation', 'post_buy_perf_9mo',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_buy_perf_12mo'
        db.add_column(u'sdapp_affiliation', 'post_buy_perf_12mo',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.qtrs_with_10b_sales_in_tracking_period'
        db.add_column(u'sdapp_affiliation', 'qtrs_with_10b_sales_in_tracking_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_3_mo_decline_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_decline_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_3_mo_measured_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_measured_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_6_mo_decline_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_decline_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_6_mo_measured_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_measured_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_9_mo_decline_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_decline_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_9_mo_measured_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_measured_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_12_mo_decline_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_decline_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.sale_qtr_ct_12_mo_measured_10b'
        db.add_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_measured_10b',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_3mo_10b'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_3mo_10b',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_6mo_10b'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_6mo_10b',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_9mo_10b'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_9mo_10b',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Affiliation.post_sale_perf_12mo_10b'
        db.add_column(u'sdapp_affiliation', 'post_sale_perf_12mo_10b',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Affiliation.selling_date_disc'
        db.delete_column(u'sdapp_affiliation', 'selling_date_disc')

        # Deleting field 'Affiliation.selling_close_price_disc'
        db.delete_column(u'sdapp_affiliation', 'selling_close_price_disc')
        ...
        # Deleting field 'Affiliation.selling_prior_performance_disc'
        db.delete_column(u'sdapp_affiliation', 'selling_prior_performance_disc')

        # Deleting field 'Affiliation.selling_subs_performance_disc'
        db.delete_column(u'sdapp_affiliation', 'selling_subs_performance_disc')

        # Deleting field 'Affiliation.increase_in_buying_disc'
        db.delete_column(u'sdapp_affiliation', 'increase_in_buying_disc')

        # Deleting field 'Affiliation.buying_date_disc'
        db.delete_column(u'sdapp_affiliation', 'buying_date_disc')

        # Deleting field 'Affiliation.buying_close_price_disc'
        db.delete_column(u'sdapp_affiliation', 'buying_close_price_disc')

        # Deleting field 'Affiliation.price_motivated_buy_detected_disc'
        db.delete_column(u'sdapp_affiliation', 'price_motivated_buy_detected_disc')

        # Deleting field 'Affiliation.buying_prior_performance_disc'
        db.delete_column(u'sdapp_affiliation', 'buying_prior_performance_disc')

        # Deleting field 'Affiliation.buying_subs_performance_disc'
        db.delete_column(u'sdapp_affiliation', 'buying_subs_performance_disc')
        ...
        # Deleting field 'Affiliation.qtrs_with_disc_sales_in_tracking_period'
        db.delete_column(u'sdapp_affiliation', 'qtrs_with_disc_sales_in_tracking_period')

        # Deleting field 'Affiliation.sale_qtr_ct_3_mo_decline_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_decline_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_3_mo_measured_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_measured_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_6_mo_decline_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_decline_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_6_mo_measured_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_measured_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_9_mo_decline_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_decline_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_9_mo_measured_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_measured_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_12_mo_decline_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_decline_disc')

        # Deleting field 'Affiliation.sale_qtr_ct_12_mo_measured_disc'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_measured_disc')

        # Deleting field 'Affiliation.post_sale_perf_3mo_disc'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_3mo_disc')

        # Deleting field 'Affiliation.post_sale_perf_6mo_disc'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_6mo_disc')

        # Deleting field 'Affiliation.post_sale_perf_9mo_disc'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_9mo_disc')

        # Deleting field 'Affiliation.post_sale_perf_12mo_disc'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_12mo_disc')

        # Deleting field 'Affiliation.qtrs_with_buys_in_tracking_period'
        db.delete_column(u'sdapp_affiliation', 'qtrs_with_buys_in_tracking_period')

        # Deleting field 'Affiliation.buy_qtr_ct_3_mo_increase'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_3_mo_increase')

        # Deleting field 'Affiliation.buy_qtr_ct_3_mo_measured'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_3_mo_measured')

        # Deleting field 'Affiliation.buy_qtr_ct_6_mo_increase'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_6_mo_increase')

        # Deleting field 'Affiliation.buy_qtr_ct_6_mo_measured'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_6_mo_measured')

        # Deleting field 'Affiliation.buy_qtr_ct_9_mo_increase'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_9_mo_increase')

        # Deleting field 'Affiliation.buy_qtr_ct_9_mo_measured'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_9_mo_measured')

        # Deleting field 'Affiliation.buy_qtr_ct_12_mo_increase'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_12_mo_increase')

        # Deleting field 'Affiliation.buy_qtr_ct_12_mo_measured'
        db.delete_column(u'sdapp_affiliation', 'buy_qtr_ct_12_mo_measured')

        # Deleting field 'Affiliation.post_buy_perf_3mo'
        db.delete_column(u'sdapp_affiliation', 'post_buy_perf_3mo')

        # Deleting field 'Affiliation.post_buy_perf_6mo'
        db.delete_column(u'sdapp_affiliation', 'post_buy_perf_6mo')

        # Deleting field 'Affiliation.post_buy_perf_9mo'
        db.delete_column(u'sdapp_affiliation', 'post_buy_perf_9mo')

        # Deleting field 'Affiliation.post_buy_perf_12mo'
        db.delete_column(u'sdapp_affiliation', 'post_buy_perf_12mo')

        # Deleting field 'Affiliation.qtrs_with_10b_sales_in_tracking_period'
        db.delete_column(u'sdapp_affiliation', 'qtrs_with_10b_sales_in_tracking_period')

        # Deleting field 'Affiliation.sale_qtr_ct_3_mo_decline_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_decline_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_3_mo_measured_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_3_mo_measured_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_6_mo_decline_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_decline_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_6_mo_measured_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_6_mo_measured_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_9_mo_decline_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_decline_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_9_mo_measured_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_9_mo_measured_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_12_mo_decline_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_decline_10b')

        # Deleting field 'Affiliation.sale_qtr_ct_12_mo_measured_10b'
        db.delete_column(u'sdapp_affiliation', 'sale_qtr_ct_12_mo_measured_10b')

        # Deleting field 'Affiliation.post_sale_perf_3mo_10b'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_3mo_10b')

        # Deleting field 'Affiliation.post_sale_perf_6mo_10b'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_6mo_10b')

        # Deleting field 'Affiliation.post_sale_perf_9mo_10b'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_9mo_10b')

        # Deleting field 'Affiliation.post_sale_perf_12mo_10b'
        db.delete_column(u'sdapp_affiliation', 'post_sale_perf_12mo_10b')
