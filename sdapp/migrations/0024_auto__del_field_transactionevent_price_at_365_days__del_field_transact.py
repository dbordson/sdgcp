...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TransactionEvent.price_at_365_days'
        db.delete_column(u'sdapp_transactionevent', 'price_at_365_days')

        # Deleting field 'TransactionEvent.price_at_182_days'
        db.delete_column(u'sdapp_transactionevent', 'price_at_182_days')

        # Deleting field 'TransactionEvent.price_at_91_days'
        db.delete_column(u'sdapp_transactionevent', 'price_at_91_days')

        # Deleting field 'TransactionEvent.price_at_456_days'
        db.delete_column(u'sdapp_transactionevent', 'price_at_456_days')

        # Deleting field 'TransactionEvent.price_at_274_days'
        db.delete_column(u'sdapp_transactionevent', 'price_at_274_days')

        # Adding field 'TransactionEvent.perf_at_91_days'
        db.add_column(u'sdapp_transactionevent', 'perf_at_91_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.perf_at_182_days'
        db.add_column(u'sdapp_transactionevent', 'perf_at_182_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.perf_at_274_days'
        db.add_column(u'sdapp_transactionevent', 'perf_at_274_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.perf_at_365_days'
        db.add_column(u'sdapp_transactionevent', 'perf_at_365_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.perf_at_456_days'
        db.add_column(u'sdapp_transactionevent', 'perf_at_456_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TransactionEvent.price_at_365_days'
        db.add_column(u'sdapp_transactionevent', 'price_at_365_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.price_at_182_days'
        db.add_column(u'sdapp_transactionevent', 'price_at_182_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.price_at_91_days'
        db.add_column(u'sdapp_transactionevent', 'price_at_91_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.price_at_456_days'
        db.add_column(u'sdapp_transactionevent', 'price_at_456_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Adding field 'TransactionEvent.price_at_274_days'
        db.add_column(u'sdapp_transactionevent', 'price_at_274_days',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2),
                      keep_default=False)

        # Deleting field 'TransactionEvent.perf_at_91_days'
        db.delete_column(u'sdapp_transactionevent', 'perf_at_91_days')

        # Deleting field 'TransactionEvent.perf_at_182_days'
        db.delete_column(u'sdapp_transactionevent', 'perf_at_182_days')

        # Deleting field 'TransactionEvent.perf_at_274_days'
        db.delete_column(u'sdapp_transactionevent', 'perf_at_274_days')

        # Deleting field 'TransactionEvent.perf_at_365_days'
        db.delete_column(u'sdapp_transactionevent', 'perf_at_365_days')

        # Deleting field 'TransactionEvent.perf_at_456_days'
        db.delete_column(u'sdapp_transactionevent', 'perf_at_456_days')
    ...
    models = {
        ...
        u'sdapp.transactionevent': {
            ...
            'perf_at_182_days': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'perf_at_274_days': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'perf_at_365_days': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'perf_at_456_days': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
            'perf_at_91_days': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2'}),
