...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportingPersonAtts.t_perf'
        db.add_column(u'sdapp_reportingpersonatts', 't_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_perf'
        db.add_column(u'sdapp_reportingpersonatts', 'b_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.s_perf'
        db.add_column(u'sdapp_reportingpersonatts', 's_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ReportingPersonAtts.t_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 't_perf')

        # Deleting field 'ReportingPersonAtts.b_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_perf')

        # Deleting field 'ReportingPersonAtts.s_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 's_perf')
