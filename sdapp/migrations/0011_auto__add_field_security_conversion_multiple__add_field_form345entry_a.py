...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Security.conversion_multiple'
        db.add_column(u'sdapp_security', 'conversion_multiple',
                      self.gf('django.db.models.fields.DecimalField')(default='1.00', max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Form345Entry.adjustment_factor'
        db.add_column(u'sdapp_form345entry', 'adjustment_factor',
                      self.gf('django.db.models.fields.DecimalField')(default='1.00', max_digits=15, decimal_places=4),
                      keep_default=False)

        # Adding field 'Form345Entry.adjustment_date'
        db.add_column(u'sdapp_form345entry', 'adjustment_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Form345Entry.underlying_security'
        db.add_column(u'sdapp_form345entry', 'underlying_security',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='underlying_relationship', null=True, to=orm['sdapp.Security']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Security.conversion_multiple'
        db.delete_column(u'sdapp_security', 'conversion_multiple')

        # Deleting field 'Form345Entry.adjustment_factor'
        db.delete_column(u'sdapp_form345entry', 'adjustment_factor')

        # Deleting field 'Form345Entry.adjustment_date'
        db.delete_column(u'sdapp_form345entry', 'adjustment_date')

        # Deleting field 'Form345Entry.underlying_security'
        db.delete_column(u'sdapp_form345entry', 'underlying_security_id')
