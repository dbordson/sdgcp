...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscretionaryXnEvent.person_title'
        db.add_column(u'sdapp_discretionaryxnevent', 'person_title',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscretionaryXnEvent.person_title'
        db.delete_column(u'sdapp_discretionaryxnevent', 'person_title')
