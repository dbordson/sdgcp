...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransactionEvent.end_holding_val'
        db.alter_column(u'sdapp_transactionevent', 'end_holding_val', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.net_xn_pct'
        db.alter_column(u'sdapp_transactionevent', 'net_xn_pct', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.net_xn_val'
        db.alter_column(u'sdapp_transactionevent', 'net_xn_val', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'TransactionEvent.end_holding_val'
        db.alter_column(u'sdapp_transactionevent', 'end_holding_val', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.net_xn_pct'
        db.alter_column(u'sdapp_transactionevent', 'net_xn_pct', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.net_xn_val'
        db.alter_column(u'sdapp_transactionevent', 'net_xn_val', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))
