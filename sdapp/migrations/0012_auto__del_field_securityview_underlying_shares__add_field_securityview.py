...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SecurityView.underlying_shares'
        db.delete_column(u'sdapp_securityview', 'underlying_shares')

        # Adding field 'SecurityView.underlying_shares_total'
        db.add_column(u'sdapp_securityview', 'underlying_shares_total',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SecurityView.underlying_shares'
        db.add_column(u'sdapp_securityview', 'underlying_shares',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4),
                      keep_default=False)

        # Deleting field 'SecurityView.underlying_shares_total'
        db.delete_column(u'sdapp_securityview', 'underlying_shares_total')
