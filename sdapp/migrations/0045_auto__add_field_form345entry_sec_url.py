...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.sec_url'
        db.add_column(u'sdapp_form345entry', 'sec_url',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.sec_url'
        db.delete_column(u'sdapp_form345entry', 'sec_url')
