...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportingPersonAtts.tot_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 'tot_perf')

        # Deleting field 'ReportingPersonAtts.buy_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 'buy_perf')

        # Deleting field 'ReportingPersonAtts.sell_perf'
        db.delete_column(u'sdapp_reportingpersonatts', 'sell_perf')

        # Adding field 'ReportingPersonAtts.t_win_rate'
        db.add_column(u'sdapp_reportingpersonatts', 't_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.b_win_rate'
        db.add_column(u'sdapp_reportingpersonatts', 'b_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.s_win_rate'
        db.add_column(u'sdapp_reportingpersonatts', 's_win_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.perf'
        db.add_column(u'sdapp_reportingpersonatts', 'perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReportingPersonAtts.tot_perf'
        db.add_column(u'sdapp_reportingpersonatts', 'tot_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.buy_perf'
        db.add_column(u'sdapp_reportingpersonatts', 'buy_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Adding field 'ReportingPersonAtts.sell_perf'
        db.add_column(u'sdapp_reportingpersonatts', 'sell_perf',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=4),
                      keep_default=False)

        # Deleting field 'ReportingPersonAtts.t_win_rate'
        db.delete_column(u'sdapp_reportingpersonatts', 't_win_rate')

        # Deleting field 'ReportingPersonAtts.b_win_rate'
        db.delete_column(u'sdapp_reportingpersonatts', 'b_win_rate')

        # Deleting field 'ReportingPersonAtts.s_win_rate'
        db.delete_column(u'sdapp_reportingpersonatts', 's_win_rate')

        # Deleting field 'ReportingPersonAtts.perf'
        db.delete_column(u'sdapp_reportingpersonatts', 'perf')
    ...
    models = {
        ...
        u'sdapp.reportingpersonatts': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'perf': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '4'}),
