...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TransactionEvent.perf_at_91_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_91_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.price_at_period_end'
        db.alter_column(u'sdapp_transactionevent', 'price_at_period_end', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.perf_at_182_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_182_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.perf_at_365_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_365_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.perf_at_456_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_456_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

        # Changing field 'TransactionEvent.perf_at_274_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_274_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'TransactionEvent.perf_at_91_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_91_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.price_at_period_end'
        db.alter_column(u'sdapp_transactionevent', 'price_at_period_end', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.perf_at_182_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_182_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.perf_at_365_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_365_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.perf_at_456_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_456_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'TransactionEvent.perf_at_274_days'
        db.alter_column(u'sdapp_transactionevent', 'perf_at_274_days', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))
