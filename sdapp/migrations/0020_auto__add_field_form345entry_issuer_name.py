...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.issuer_name'
        db.add_column(u'sdapp_form345entry', 'issuer_name',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.issuer_name'
        db.delete_column(u'sdapp_form345entry', 'issuer_name')
