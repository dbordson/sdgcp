...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Signal'
        db.create_table(u'sdapp_signal', (
            ...
            ('signal_name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('signal_date', self.gf('django.db.models.fields.DateField')()),
            ('formentrysource', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('security_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4)),
            ('signal_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4)),
            ('transactions', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('unit_conversion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4)),
            ('statement', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'sdapp', ['Signal'])


    def backwards(self, orm):
        # Deleting model 'Signal'
        db.delete_table(u'sdapp_signal')
    ...
    models = {
        ...
        u'sdapp.signal': {
            ...
            'formentrysource': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issuer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sdapp.IssuerCIK']"}),
            'reporting_person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sdapp.ReportingPerson']"}),
            'security': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sdapp.Security']"}),
            ...
            'signal_name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
