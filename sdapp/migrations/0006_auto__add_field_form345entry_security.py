...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form345Entry.security'
        db.add_column(u'sdapp_form345entry', 'security',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sdapp.Security'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form345Entry.security'
        db.delete_column(u'sdapp_form345entry', 'security_id')
