...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Holding.latest_transaction_date'
        db.delete_column(u'sdapp_holding', 'latest_transaction_date')
    ...
    def backwards(self, orm):
        # Adding field 'Holding.latest_transaction_date'
        db.add_column(u'sdapp_holding', 'latest_transaction_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)
